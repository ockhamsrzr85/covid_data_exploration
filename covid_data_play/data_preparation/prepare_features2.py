...
if __name__ == '__main__':
    ...
    # preventable_deaths['location'].to_list()
    locations_with_prevent_deaths_data = \
        ['Albania', 'Australia', 'Austria', 'Belarus', 'Belgium', 'Bosnia and Herzegovina', 'Bulgaria',
         ...
         'Luxembourg', 'Malta', 'Mexico', 'Moldova', 'Montenegro', 'Netherlands', 'New Zealand',
    ...
    full_data.to_pickle(f"{OUT_DIR}/features2.pkl")
